 ...
 * respectively, by the @c configure script at the top level of the libLX
 * distribution.
 * 
 ...
 * are stored in the source repository and must be updated by the libLX
...
#include <liblx/common/libsbxml-config-common.h>
