 ...
 *
 * @class XMLNode
 * @sbmlbrief{core} A node in libLX's XML document tree.
 *
 * LibLX implements an XML abstraction layer.  This layer presents a
 * uniform XML interface to calling programs regardless of which underlying
 * XML parser libLX has actually been configured to use.  The basic data
 ...
 *
 * LibLX provides the following utility functions for converting an XML
...
class LIBLX_EXTERN XMLNode : public XMLToken
{
public:
